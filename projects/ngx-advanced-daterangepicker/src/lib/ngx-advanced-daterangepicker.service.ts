    ...
    return [
      {
        ...
        display: DateSelectionDisplayTypes.TODAY,
        mode: SelectionModeTypes.DAY,
        displayType: SelectionDisplayTypes.THIS,
      },
      {
        type: DateSelectionTypes.YESTERDAY,
        display: DateSelectionDisplayTypes.YESTERDAY,
        mode: SelectionModeTypes.DAY,
        displayType: SelectionDisplayTypes.THIS,
      },
      {
        type: DateSelectionTypes.THIS_WEEK,
        display: DateSelectionDisplayTypes.THIS_WEEK,
        mode: SelectionModeTypes.WEEK,
        displayType: SelectionDisplayTypes.THIS,
      },
      {
        type: DateSelectionTypes.LAST_WEEK,
        display: DateSelectionDisplayTypes.LAST_WEEK,
        mode: SelectionModeTypes.WEEK,
        displayType: SelectionDisplayTypes.LAST,
      },
      {
        type: DateSelectionTypes.NEXT_WEEK,
        display: DateSelectionDisplayTypes.NEXT_WEEK,
        mode: SelectionModeTypes.WEEK,
        displayType: SelectionDisplayTypes.NEXT,
      },
      {
        type: DateSelectionTypes.LAST_7_DAYS,
        display: DateSelectionDisplayTypes.LAST_7_DAYS,
        mode: SelectionModeTypes.WEEK,
        displayType: SelectionDisplayTypes.LAST,
      },
      {
        type: DateSelectionTypes.NEXT_7_DAYS,
        display: DateSelectionDisplayTypes.NEXT_7_DAYS,
        mode: SelectionModeTypes.WEEK,
        displayType: SelectionDisplayTypes.NEXT,
      },
      {
        type: DateSelectionTypes.THIS_MONTH,
        display: DateSelectionDisplayTypes.THIS_MONTH,
        mode: SelectionModeTypes.MONTH,
        displayType: SelectionDisplayTypes.THIS,
      },
      {
        type: DateSelectionTypes.LAST_MONTH,
        display: DateSelectionDisplayTypes.LAST_MONTH,
        mode: SelectionModeTypes.MONTH,
        displayType: SelectionDisplayTypes.LAST,
      },
      {
        type: DateSelectionTypes.NEXT_MONTH,
        display: DateSelectionDisplayTypes.NEXT_MONTH,
        mode: SelectionModeTypes.MONTH,
        displayType: SelectionDisplayTypes.NEXT,
      },
      {
        type: DateSelectionTypes.LAST_30_DAYS,
        display: DateSelectionDisplayTypes.LAST_30_DAYS,
        mode: SelectionModeTypes.MONTH,
        displayType: SelectionDisplayTypes.LAST,
      },
      {
        type: DateSelectionTypes.NEXT_30_DAYS,
        display: DateSelectionDisplayTypes.NEXT_30_DAYS,
        mode: SelectionModeTypes.MONTH,
        displayType: SelectionDisplayTypes.NEXT,
      },
      {
        type: DateSelectionTypes.THIS_QUARTER,
        display: DateSelectionDisplayTypes.THIS_QUARTER,
        mode: SelectionModeTypes.QUARTER,
        displayType: SelectionDisplayTypes.THIS,
      },
      {
        type: DateSelectionTypes.LAST_QUARTER,
        display: DateSelectionDisplayTypes.LAST_QUARTER,
        mode: SelectionModeTypes.QUARTER,
        displayType: SelectionDisplayTypes.LAST,
      },
      {
        type: DateSelectionTypes.NEXT_QUARTER,
        display: DateSelectionDisplayTypes.NEXT_QUARTER,
        mode: SelectionModeTypes.QUARTER,
        displayType: SelectionDisplayTypes.NEXT,
      },
      {
        type: DateSelectionTypes.LAST_90_DAYS,
        display: DateSelectionDisplayTypes.LAST_90_DAYS,
        mode: SelectionModeTypes.QUARTER,
        displayType: SelectionDisplayTypes.LAST,
      },
      {
        type: DateSelectionTypes.NEXT_90_DAYS,
        display: DateSelectionDisplayTypes.NEXT_90_DAYS,
        mode: SelectionModeTypes.QUARTER,
        displayType: SelectionDisplayTypes.NEXT,
      },
      {
        type: DateSelectionTypes.LAST_12_MONTHS,
        display: DateSelectionDisplayTypes.LAST_12_MONTHS,
        mode: SelectionModeTypes.YEAR,
        displayType: SelectionDisplayTypes.LAST,
      },
      {
        type: DateSelectionTypes.NEXT_12_MONTHS,
        display: DateSelectionDisplayTypes.NEXT_12_MONTHS,
        mode: SelectionModeTypes.YEAR,
        displayType: SelectionDisplayTypes.NEXT,
      },
      {
        type: DateSelectionTypes.LAST_YEAR,
        display: DateSelectionDisplayTypes.LAST_YEAR,
        mode: SelectionModeTypes.YEAR,
        displayType: SelectionDisplayTypes.LAST,
      },
      {
        type: DateSelectionTypes.NEXT_YEAR,
        display: DateSelectionDisplayTypes.NEXT_YEAR,
        mode: SelectionModeTypes.YEAR,
        displayType: SelectionDisplayTypes.NEXT,
      },
      {
        type: DateSelectionTypes.THIS_YEAR,
        display: DateSelectionDisplayTypes.THIS_YEAR,
        mode: SelectionModeTypes.YEAR,
        displayType: SelectionDisplayTypes.THIS,
      },
      {
        type: DateSelectionTypes.CUSTOM,
        display: DateSelectionDisplayTypes.CUSTOM,
